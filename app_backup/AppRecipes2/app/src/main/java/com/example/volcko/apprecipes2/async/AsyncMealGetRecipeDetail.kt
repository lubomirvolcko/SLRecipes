...
class AsyncMealGetRecipeDetail (
    var c: Context?,
    //var rv: RecyclerView,
    var fav: Boolean,
    val id: String,
    ...
    fun doCategories(): Boolean{
        ...
        val call = service?.getRecipeDetail(id)
        ...
        call?.enqueue(object : Callback<RecipesFeed> {
            ...
            override fun onResponse(call: Call<RecipesFeed>, response: Response<RecipesFeed>) {
                ...
                if (rec!=null) {
                    ...
                    Toast.makeText(c, "Failed to load Recipe", Toast.LENGTH_SHORT).show()
