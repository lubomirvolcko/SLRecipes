    ...
    fun doLogin(): Boolean{
        ...
        call?.enqueue(object : Callback<UserInfo> {
            override fun onResponse(call: Call<UserInfo>, response: Response<UserInfo>) {
                ...
                activityIntent.putExtra("lastViewed1", usersList?.get(0)?.lastView1.toString())
                activityIntent.putExtra("lastViewed2", usersList?.get(0)?.lastView2.toString())
                activityIntent.putExtra("lastViewed3", usersList?.get(0)?.lastView3.toString())
